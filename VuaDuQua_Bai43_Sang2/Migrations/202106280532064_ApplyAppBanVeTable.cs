namespace VuaDuQua_Bai43_Sang2.Migrations
{
    ...
    public partial class ApplyAppBanVeTable : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    TenMonHoc = c.String(),
                    MaChuyenNganh = c.String(maxLength: 128),
                })
                .PrimaryKey(t => t.MaMonHoc)
                .ForeignKey("dbo.ChuyenNganhs", t => t.MaChuyenNganh)
            ...
            CreateTable(
                ...
                c => new
                {
                    MaDangKy = c.String(nullable: false, maxLength: 128),
